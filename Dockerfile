...
RUN mkdir -p /opt/kcptun && \
	wget -O /root/kcptun-linux-amd64.tar.gz --no-check-certificate https://github.com/xtaci/kcptun/releases/download/SNMP_Milestone/kcptun-linux-amd64-20160605.tar.gz && \
	cd /opt/kcptun && \
